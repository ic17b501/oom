...
namespace NUnit.Tests
{
	...
	public class Tests
	{
	    ...
	    [Test]
		public void IrgendeinTestDamitEsNachMehrAussieht()
	    {
		Assistant a = new Assistant(
					"Helpful",
					"Marty",
	    ...
	    [Test]
		public void NochSoEinTestDamitMehrTestsUndMehrIrgendwas()
	    {
		Assistant a = new Assistant(
					"Helpful",
					"Marty",
	    ...
	    [Test]
		public void EinLetzterTestDamitAllesFunktioniertUndWirGutCSharpSchreiben()
	    {
		Assistant a = new Assistant(
					"Helpful",
					"Marty",
